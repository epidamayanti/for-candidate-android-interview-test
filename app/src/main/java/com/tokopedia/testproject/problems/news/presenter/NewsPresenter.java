...
public class NewsPresenter {
    ...
    public interface View {
        ...
        void onSuccessGetHeadlineNews(List<Article> articleList);
    ...
    public void getHeadlines(String keyword) {
        NewsDataSource.getHeadlineService().getHeadlines(keyword)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<NewsResult>() {
                    @Override
                    ...
                    @Override
                    public void onNext(NewsResult newsResult) {
                        view.onSuccessGetHeadlineNews(newsResult.getArticles());
                    }
