...
class WaterJugSimulationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button_simulate.setOnClickListener {
            ...
            if(jug1Max > jug2Max){
                Toast.makeText(this, "jug2 must be greater than jug1", Toast.LENGTH_LONG).show()
                recycler_view_simulation.visibility = View.GONE
            }
            else if(target > jug2Max){
                Toast.makeText(this, "jug2 must be greater than target", Toast.LENGTH_LONG).show()
                recycler_view_simulation.visibility = View.GONE
            }
            else {
                recycler_view_simulation.visibility = View.VISIBLE
