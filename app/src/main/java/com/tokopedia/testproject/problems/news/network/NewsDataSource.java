...
public class NewsDataSource {
    ...
    private static HeadlineNewsService headlines_service;
    ...
    public static HeadlineNewsService getHeadlineService() {
        if (headlines_service == null) {
            final Retrofit.Builder builder = new Retrofit.Builder()
                    .addCallAdapterFactory(RxJava2CallAdapterFactory.create())
                    .addConverterFactory(GsonConverterFactory.create());
            ...
            OkHttpClient okHttpClient = okHttpClientBuilder
                    ...
                    .build();
            Retrofit retrofit = builder.baseUrl(NewsURL.BASE_URL).client(okHttpClient).build();
            headlines_service = retrofit.create(HeadlineNewsService.class);
        }
        return headlines_service;
    }
